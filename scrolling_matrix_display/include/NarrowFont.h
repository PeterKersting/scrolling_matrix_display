...
MD_MAX72XX::fontType_t _font[] PROGMEM =
{
  'F', 2, 0, 0, 0, 255, 8,
  0,    // 0 - 'Empty Cell'
  7, 28, 34, 65, 79, 73, 42, 28,   // 1 'Set Time'
  6, 48, 62, 63, 127, 62, 48, // 2 - 'Set Alarm'
  7, 24, 24, 60, 126, 0, 36, 24,    // 3 - 'Set Volume'
  7, 8, 34, 8, 93, 8, 34, 8,  // 4 - 'Set Brightness'
  6, 48, 62, 4, 96, 124, 8, // 5 - 'Set Song'
  7, 28, 34, 65, 79, 79, 46, 28,    // 6 - 'Set Wakeup Time'
  ...
  3, 62, 65, 65,    // 40 - '('
  3, 65, 65, 62,    // 41 - ')'
  5, 64, 112, 248, 112, 64,    // 42 - 'AlarmOn'
  5, 8, 8, 62, 8, 8,    // 43 - '+'
  2, 96, 224,   // 44 - ','
  4, 8, 8, 8, 8,    // 45 - '-'
  1, 64,    // 46 - '.'
